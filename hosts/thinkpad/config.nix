    ...
    greetd = {
      ...
      settings = {
        default_session = {
          ...
          command = "${pkgs.greetd.regreet}/bin/tuigreet --time --cmd Hyprland --user-menu --theme 'border=magenta;text=cyan;prompt=green;time=red;action=blue;button=yellow;container=black;input=red'";
        };
      };
    };
    smartd = {
    ...
    kanata = {
      ...
      keyboards = {
        default = {
          ...
          configFile = ../../config/term/kanata/config.kbd;
        };
      };
    };
  };
